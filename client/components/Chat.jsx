          ...
          {data?.messages?.map((msg, index) => (
            <div key={index} className="flex flex-col space-y-1">
              <div className="flex items-end justify-end gap-2.5 m-4">
                <div className="bg-orange-300 p-3 rounded-lg self-end w-full md:w-1/3 shadow-md text-gray-800 font-medium">
              ...
              <div className="flex items-start gap-2.5 m-4">
                <User
                  ...
                  size={32}
                />
                <div className="bg-gray-300 p-3 rounded-lg self-start w-full md:w-1/2 shadow-md text-gray-800 font-medium">
